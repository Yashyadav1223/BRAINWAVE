    ...
    >
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        <nav
          ...
          } fixed top-[5rem] left-0 right-0 border-0 bg-n-8
        ...
        <a
          href="#signup"
          className="button hidden mr-8 text-n-1/50 transition-colors hover:text-n-1 lg:inline-block"
        >
          New account
        </a>
        ...
        {/* Mobile Menu Button */}
        <Button
          className="ml-auto lg:hidden inline-flex"
          px="px-3"
